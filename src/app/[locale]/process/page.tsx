        ...
        <Container>
          <div className="max-w-5xl mx-auto space-y-8">
            ...
            <AnimatedSection className="bg-[#13131E] border border-[#1E1E2E] rounded-xl p-8">
              ...
              <p className="text-[#94A3B8] mb-4"><strong className="text-[#F8F8FF]">Option 2 Get Custom Project Scope:</strong> This is best for businesses that want to define the need more clearly before booking a call.</p>
